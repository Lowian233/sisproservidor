...
class PermisoUsuarioController extends Controller
{
    ...
    private function esPersInter1(): bool
    {
        return in_array(Auth::user()->UsRol, Permisos::PersInter1)
            || in_array(Auth::user()->UsRol2, Permisos::PersInter1);
    }

    private function esJefe(): bool
    {
        return in_array(Auth::user()->UsRol, Permisos::Jefes)
            || in_array(Auth::user()->UsRol2, Permisos::Jefes);
    }

    private function esProgramador(): bool
    {
        return in_array(Auth::user()->UsRol, Permisos::PROGRAMADOR)
