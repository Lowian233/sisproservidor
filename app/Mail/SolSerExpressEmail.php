   ...
   public function build()
    {
        ...
        if ($this->certificado->CertType == 0) {
            ...
            ->subject('CERTIFICADO '.'E-'.sprintf("%07s", $this->certificado->ID_Cert).' - Servicio #'.$this->email->ID_SolSer.' - '.$this->email->CliName);
        }else{
            ...
            ->subject('MANIFIESTO '.'ME-'.sprintf("%07s", $this->certificado->CertManifNumero).' - Servicio #'.$this->email->ID_SolSer.' - '.$this->email->CliName);
        }
