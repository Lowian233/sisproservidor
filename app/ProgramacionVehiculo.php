...
class ProgramacionVehiculo extends Model
{
    ...
    public function Vehiculo(){
        return $this->belongsTo('App\Vehiculo', 'FK_ProgVehiculo', 'ID_Vehic');
    }
    public function Conductor(){
        return $this->belongsTo('App\Personal', 'FK_ProgConductor', 'ID_Pers');
    }
    public function Ayudante(){
        return $this->belongsTo('App\Personal', 'FK_ProgAyudante', 'ID_Pers');
    }
