...
class SolicitudServicio extends Model
{
	...
	public function fecharecepcionado()
	{
		return $this->Observaciones()->where('ObsStatus', 'Recepcionado')->orderBy('ObsDate', 'desc')->first();
	}
