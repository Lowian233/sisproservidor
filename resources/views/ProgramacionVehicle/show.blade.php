									...
									@foreach($GenerResiduos as $GenerResiduo)
										@foreach($Residuos as $Residuo)
											...
											<tr>
												...
												<td>{{$GenerResiduo->GSedeAddress}} - Municipio:{{ $GenerResiduo->MunName ?? 'N/A' }}</td>
														...
														@foreach($Residuos as $Residuo)
															...
															<div class="col-md-12 col-xs-12">
																...
																<div class="col-md-4 col-xs-4" style="border-bottom: 2px solid black; border-left: 1px solid black;">
																	<label style="text-align: center;">Devoluci??n/Auditoria</label>
																	<div style="width: 100%;">
