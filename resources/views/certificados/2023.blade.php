								...
								<tr>
									...
									@switch($certificado->CertType)
										...
										@case(2)
											...
											<td class="text-center">
												<a method='get' href="{{ asset('storage/manifiestosRegular/'.$certificado->CertSrc.'') }}?v={{ file_exists($_yM2Path) ? filemtime($_yM2Path) : time() }}" target='_blank' class='btn btn-warning'>
