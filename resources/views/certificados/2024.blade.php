								...
								<tr>
									...
									<td>{{$certificado->CertObservacion}}</td>
										...
										@case(0)
											@if($certificado->CertSrc!=="CertificadoDefault.pdf")
												@php
													...
													$_yCertHref = file_exists($_yCertPath)
														? asset('storage/certificadoRegular/'.$certificado->CertSrc.'').'?v='.filemtime($_yCertPath)
														: asset('img/Certificados/'.$certificado->CertSrc.'').'?v='.(file_exists($_yCertImg) ? filemtime($_yCertImg) : time());
												@endphp
												<td class="text-center"><a method='get' href="{{ $_yCertHref }}"  target='_blank' class='btn btn-success'><i class='fas fa-file-contract fa-lg'></a></td>
											@else
										...
										@case(1)
											@if($certificado->CertSrc!=="CertificadoDefault.pdf")
												@php
													$_ymName = ($certificado->CertSrc !== 'CertificadoDefault.pdf') ? $certificado->CertSrc : $certificado->CertSrcManif;
													$_ymPath = storage_path('app/public/manifiestosRegular/'.$_ymName);
													$_ymImg = public_path('img/Manifiestos/'.$_ymName);
													$_ymHref = file_exists($_ymPath)
														? asset('storage/manifiestosRegular/'.$_ymName.'').'?v='.filemtime($_ymPath)
														: asset('img/Manifiestos/'.$_ymName.'').'?v='.(file_exists($_ymImg) ? filemtime($_ymImg) : time());
												@endphp
												<td class="text-center"><a method='get' href="{{ $_ymHref }}" target='_blank' class='btn btn-primary'><i class='far fa-file-alt fa-lg'></a></td>
											@else
										...
										@case(2)
                                            @if($certificado->CertSrc!=="CertificadoDefault.pdf")
												@php
													$_yM2Path = storage_path('app/public/manifiestosRegular/'.$certificado->CertSrc);
													$_yM2Href = asset('storage/manifiestosRegular/'.$certificado->CertSrc.'').'?v='.(file_exists($_yM2Path) ? filemtime($_yM2Path) : time());
												@endphp
                                            <td class="text-center">
                                                <a method='get' href="{{ $_yM2Href }}" target='_blank' class='btn btn-warning'><i class='far fa-file-alt fa-lg'></i></a></td>
											@else
												<td class="text-center"><a disabled method='get' href='/img/CertificadoDefault.pdf' target='_blank' class='btn btn-default'><i class='far fa-file-alt fa-lg'></a></td>
											@endif
											@break
