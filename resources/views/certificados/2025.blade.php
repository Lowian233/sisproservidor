								...
								<tr>
									...
									<td>{{$certificado->CertObservacion}}</td>
										...
										@case(2)
                                            @if($certificado->CertSrc!=="CertificadoDefault.pdf")
												@php
													$_yExtSt = storage_path('app/public/certificadoExt/'.$certificado->CertSrc);
													$_yExtHref = asset('storage/certificadoExt/'.$certificado->CertSrc.'').'?v='.(file_exists($_yExtSt) ? filemtime($_yExtSt) : time());
												@endphp
                                             <td class="text-center">
                                                <a method='get' href="{{ $_yExtHref }}" target='_blank' class='btn btn-warning'><i class='far fa-file-alt fa-lg'></i></a></td>
											@else
												<td class="text-center"><a disabled method='get' href='/img/CertificadoDefault.pdf' target='_blank' class='btn btn-default'><i class='far fa-file-alt fa-lg'></a></td>
											@endif
											@break
