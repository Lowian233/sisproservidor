									...
									@switch($certificado->CertType)
										@case(0)
											@if($certificado->CertSrc!=="CertificadoDefault.pdf")
												@php
													$_certPath = storage_path('app/public/certificadoRegular/'.$certificado->CertSrc);
													$_certImgPath = public_path('img/Certificados/'.$certificado->CertSrc);
												@endphp
												<td class="text-center"><a method='get' href='{{ file_exists($_certPath) ? asset('storage/certificadoRegular/'.$certificado->CertSrc).'?v='.filemtime($_certPath) : asset('img/Certificados/'.$certificado->CertSrc).'?v='.(file_exists($_certImgPath) ? filemtime($_certImgPath) : time()) }}' target='_blank' class='btn btn-success'><i class='fas fa-file-contract fa-lg'></a></td>
											@else
										...
										@case(1)
											@if($certificado->CertSrcManif!=="CertificadoDefault.pdf")
												@php
													$_manifName = ($certificado->CertSrc !== 'CertificadoDefault.pdf') ? $certificado->CertSrc : $certificado->CertSrcManif;
													$_manifPath = storage_path('app/public/manifiestosRegular/'.$_manifName);
													$_manifImgPath = public_path('img/Manifiestos/'.$_manifName);
												@endphp
												<td class="text-center"><a method='get' href='{{ file_exists($_manifPath) ? asset('storage/manifiestosRegular/'.$_manifName).'?v='.filemtime($_manifPath) : asset('img/Manifiestos/'.$_manifName).'?v='.(file_exists($_manifImgPath) ? filemtime($_manifImgPath) : time()) }}' target='_blank' class='btn btn-primary'><i class='far fa-file-alt fa-lg'></a></td>
											@else
										...
										@case(2)
											@if($certificado->CertSrcExt!=="CertificadoDefault.pdf")
												@php($_extPath = storage_path('app/public/certificadoExt/'.$certificado->CertSrcExt))
												<td class="text-center"><a method='get' href="{{ asset('storage/certificadoExt/'.$certificado->CertSrcExt) }}?v={{ file_exists($_extPath) ? filemtime($_extPath) : time() }}" target='_blank' class='btn btn-warning'><i class='far fa-file-alt fa-lg'></a></td>
											@else
												<td class="text-center"><a disabled method='get' href='/img/CertificadoDefault.pdf' target='_blank' class='btn btn-default'><i class='far fa-file-alt fa-lg'></a></td>
											@endif
											@break
