...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <style>
      ...
      body {
        background-image: url('@pdfAsset("img/WATERMARKV5.png")');
      ...
      <div class=WordSection1>
          ...
          <table width="85%" class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
           ...
           <tr width=35>
            ...
            <p class=MsoNormal><span lang=ES style='font-size:7.5pt;font-family:"Arial",sans-serif;
            color:#0D0D0D'>@php
              // Evitar "Undefined variable" y soportar casos sin recepción (común en 2026)
              $fechaBase = $certificado->recepcion ?? null;
              if (empty($fechaBase)) {
                $fechaBase = $fechaLlegadaPlanta ?? null;
              }

              $fechaRecepcionTexto = 'N/A';
              if (!empty($fechaBase)) {
                $ano = date('Y', strtotime($fechaBase));
                ...
                $fechaRecepcionTexto = trim($dia.' de '.$mesTexto.' del '.$ano);
              }
            @endphp
            {{ $fechaRecepcionTexto }}</span></p>
            </td>
           </tr>
           <tr width=35>
          ...
          @php
          $certdatoUnicos = $certificado->certdato->unique('FK_DatoCertSolRes');
          $totalfilas = 1 + $certdatoUnicos->count();
          @endphp
          ...
          $totalKg = 0;
          @endphp
          @foreach($certdatoUnicos as $certdato)
          @php $Residuo = $certificado->SolicitudServicio->SolicitudResiduo->firstWhere('ID_SolRes', $certdato->FK_DatoCertSolRes); @endphp
          @if($Residuo)
          ...
          @endforeach
           ...
           <tr>
            ...
            $mesrecepciontexto = '';
            $añorecepcion = '';
            if(!empty($certificado->recepcion)){
            $añorecepcion=date('Y', strtotime($certificado->recepcion));
            $mesrecepcion=(int)date('n', strtotime($certificado->recepcion));
            $diarecepcion=date('d', strtotime($certificado->recepcion));
            switch ($mesrecepcion) {
            case 1: $mesrecepciontexto = 'Enero'; break;
            case 2: $mesrecepciontexto = 'Febrero'; break;
            case 3: $mesrecepciontexto = 'Marzo'; break;
            case 4: $mesrecepciontexto = 'Abril'; break;
            case 5: $mesrecepciontexto = 'Mayo'; break;
            case 6: $mesrecepciontexto = 'Junio'; break;
            case 7: $mesrecepciontexto = 'Julio'; break;
            case 8: $mesrecepciontexto = 'Agosto'; break;
            case 9: $mesrecepciontexto = 'Septiembre'; break;
            case 10: $mesrecepciontexto = 'Octubre'; break;
            case 11: $mesrecepciontexto = 'Noviembre'; break;
            case 12: $mesrecepciontexto = 'Diciembre'; break;
            default: $mesrecepciontexto = ''; break;
            }
            }
            @endphp
            {{ $mesrecepciontexto ? $mesrecepciontexto . ' del ' . $añorecepcion : 'N/D' }}</span></p>
            </td>
           </tr>
           <tr>
            <td width="40" style='border:solid gray 0.5pt;border-top:none;
          ...
          <table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
           ...
           <tr style='height:8.1pt'width=30%>
              ...
              <td style='padding:0cm 0.4pt 0cm 0.4pt;height:8.1pt' width=10%>
                  <p class=MsoNormal><b><span lang=ES style='font-size:7.5pt;font-family:"Arial",sans-serif'>CESAR BENITO</span></b></p>
                  <p class=MsoNormal style='text-align:justify'><b><span lang=ES
                   style='font-size:7.5pt;font-family:"Arial",sans-serif'>Jefe Operaciones</span></b></p>
              </td>
              </tr>
          </table>
          </div>
