						...
						<table>
							<tr>
								...
								<td style="font-size: 16px; text-align: right;">
									...
									Fecha: {{ $fechaEmision->toDateString() }}
								</td>
							</tr>
						</table>
					</td>
							...
							<table>
								<tr>
									<td style="text-align: justify; font-size: 12px; line-height: 14px;">
										El <b><i>GENERADOR</i></b> entregó su(s) residuo(s) y/o desecho(s) a <b>Prosarc S.A. ESP.</b> para tratamiento de <b>TermoDestrucción</b> durante el dia <b>{{ $fechaRecepcion->toDateString() }}</b>  de acuerdo con la información del servicio <b>#{{$certificado->FK_CertSolser}}</b>:
									</td>
								</tr>
							</table>
						</td>
							...
							<table>
								<tr>
									...
									<td style="text-align: center; vertical-align: bottom; dding: 0px !important;">
										<img src="@pdfAsset('img/FirmaJohn.png')" style="width: 100px;"><br>
