            ...
            <div class="box box-info">
                <div class="box-body box-profile">
                    <div class="col-md-12 col-xs-12">
                        {{-- @if(in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) && Route::currentRouteName() !== 'cliente-show')
        ...
        <div class="col-md-8">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    @endif
                    <li class="navbar-right">
                        <button><a href="{{route('clientetarifas.create', ['slug' => $cliente->CliSlug])}}" class="btn btn-primary" target="_blank" rel="noopener noreferrer"><b><i class="fas fa-plus"></i> Tarifa</b></a></button>
                    </li>
                </ul>
