                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <form role="form" action="{{route('clientetarifas.store', ['slug' => $cliente->CliSlug])}}" method="POST" id="createtratamientoForm">
                                @csrf
                                @if ($errors->any())
                        ...
                        <div class="box">
                            <table id="TarifasClienteTable" class="table table-compact table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    @php
                                        $claseTipo = $tarifa->Tarifatipo == 'Kg' ? 'tipo-kg' : 'tipo-otro';
                                    @endphp
                                    <tr>
                                        <td>{{$tarifa->ID_CTarifa}}</td>
                                        <td>{{$tarifa->tratamiento->TratName}}</td>
                                        <td>desde {{$rango->CTarifaDesde}} <b class="{{$claseTipo}}">{{$tarifa->Tarifatipo}}</b></td>
