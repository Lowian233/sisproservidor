...
@section('NewScript')
@php
	$termodestruccionIdValue = isset($termodestruccionId) && $termodestruccionId ? $termodestruccionId : 'null';
@endphp
<script type="application/javascript">
var contador = 1;
var termodestruccionIdDefault = <?php echo $termodestruccionIdValue; ?>;
...
function AgregarRes() {
	...
	$("#myform").validator('update');
	// Establecer tratamiento predeterminado (TermoDestrucción) para el nuevo residuo
	if (termodestruccionIdDefault) {
		setTimeout(function() {
			var selectTratamiento = $("#selectTratamiento" + contador);
			if (selectTratamiento.length && termodestruccionIdDefault) {
				selectTratamiento.val(termodestruccionIdDefault);
			}
		}, 100);
	}
