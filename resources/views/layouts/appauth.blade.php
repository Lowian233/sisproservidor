...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('/img/LogoProsarc.ico')}}">
    ...
    <link href="{{ asset('/css/stilosPersonalizados.css') }}" rel="stylesheet" type="text/css" />
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <span class="logo-lg"><b>{{ config('app.name') }}</b><img src="{{ asset('img/LogoProsarc.png') }}" style="width: 1.8em; margin: 5px; border-radius: 50%;"></span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            {{-- Enlace de registro removido - solo comerciales pueden crear clientes y usuarios --}}
                        @else
    ...
    <script type="text/javascript">
      var wasSubmitted = false;
        ...
        function disabledLoginButton() {
            ...
            var turnstileInput = document.forms["LoginForm"]["cf-turnstile-response"];
            if (a !== null && a !== "", b !== null && b !== "") {
                if (validateEmail(a)) {
                    if (turnstileInput && !turnstileInput.value) {
                        alert('Por favor valide el captcha antes de continuar.');
                        return;
                    }
