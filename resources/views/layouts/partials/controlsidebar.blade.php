					...
					<li>
						...
						<form action="/changeRol/{{Auth::user()->UsSlug}}" style="margin: 1em;" method="POST">
							...
							<select id="Rol1" name="UsRol1">
								...
								<option {{ (Auth::user()->UsRol2 === 'Comercialap' ? "selected" : "" )}} value="Comercialap">Comercial de aprovechables</option>
								...
								<option {{ (Auth::user()->UsRol === 'DireccionTecnica' ? "selected" : "" )}} value="DireccionTecnica">Dirección Técnica</option>
							</select>
							...
							<select id="Rol2" name="UsRol2">
								...
								<option {{ (Auth::user()->UsRol2 === 'DireccionTecnica' ? "selected" : "" )}} value="DireccionTecnica">Dirección Técnica</option>
							</select>
