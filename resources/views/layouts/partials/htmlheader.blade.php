<head>
    ...
    <link href="{{ asset('/css/all.css') }}" rel="stylesheet" type="text/css" />
     <!-- Dependencias -->
    <link href="{{ asset('/css/dependencias.css') }}" rel="stylesheet" type="text/css">
    ...
    <!-- DataTables -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/datatable-depen.css') }}">

    {{-- plugins de datatables --}}
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/datatable-plugins.css') }}">
    ...
    {{-- Full Calendar VERDE --}}
    <link href="{{ asset('/css/calendarioPersonalizado.css') }}" rel="stylesheet" type="text/css" />
    @endif
