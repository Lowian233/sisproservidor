                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col">
                                ...
                                <form action="{{ route('reportes.ReporteLogistica') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group col-md-12">
                                        <label style="color: black; text-align: left;">Tipo de transporte</label>
                                        <select name="tipo_transporte" class="form-control col-xs-12">
                                            <option value="">Todos</option>
                                            <option value="PROSARC">Prosarc</option>
                                            <option value="Alquilado">Alquilado</option>
                                            <option value="Externo">Externo</option>
                                        </select>
                                    </div>

                                    <button type="submit" href="/reportes/ReporteLogistica" class="btn btn-info" style="margin: 10px 30px;" id="btn-buscar">Generar</button>
                                </form> 
                            </div>
                        </div>
                    </div>
