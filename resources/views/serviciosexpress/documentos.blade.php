									...
									@switch($certificado->CertType)
										@case(0)
											@if($certificado->CertSrc!=="CertificadoDefault.pdf")
												@php
													$_seCertPath = storage_path('app/public/certificadoExpress/'.$certificado->CertSrc);
													$_seCertImg = public_path('img/Certificados/'.$certificado->CertSrc);
												@endphp
												<td class="text-center"><a method='get' href='{{ file_exists($_seCertPath) ? asset('storage/certificadoExpress/'.$certificado->CertSrc).'?v='.filemtime($_seCertPath) : asset('img/Certificados/'.$certificado->CertSrc).'?v='.(file_exists($_seCertImg) ? filemtime($_seCertImg) : time()) }}' target='_blank' class='btn btn-success'><i class='fas fa-file-contract fa-lg'></a></td>
											@else
										...
										@case(1)
											@if($certificado->CertSrcManif!=="CertificadoDefault.pdf")
												@php
													$_seManifName = ($certificado->CertSrc !== 'CertificadoDefault.pdf') ? $certificado->CertSrc : $certificado->CertSrcManif;
													$_seManifPath = storage_path('app/public/manifiestosExpress/'.$_seManifName);
													$_seManifImg = public_path('img/Manifiestos/'.$_seManifName);
												@endphp
												<td class="text-center"><a method='get' href='{{ file_exists($_seManifPath) ? asset('storage/manifiestosExpress/'.$_seManifName).'?v='.filemtime($_seManifPath) : asset('img/Manifiestos/'.$_seManifName).'?v='.(file_exists($_seManifImg) ? filemtime($_seManifImg) : time()) }}' target='_blank' class='btn btn-primary'><i class='far fa-file-alt fa-lg'></a></td>
											@else
										...
										@case(2)
											@if($certificado->CertSrcExt!=="CertificadoDefault.pdf")
												@php($_seExtImg = public_path('img/CertificadosEXT/'.$certificado->CertSrcExt))
												<td class="text-center"><a method='get' href='/img/CertificadosEXT/{{$certificado->CertSrcExt}}?v={{ file_exists($_seExtImg) ? filemtime($_seExtImg) : time() }}' target='_blank' class='btn btn-warning'><i class='far fa-file-alt fa-lg'></a></td>
											@else
												<td class="text-center"><a disabled method='get' href='/img/CertificadoDefault.pdf' target='_blank' class='btn btn-default'><i class='far fa-file-alt fa-lg'></a></td>
											@endif
											@break
