                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.solserpersonal') }}</b>" data-content="{{ __('adminlte::message.solserpersonaldescript') }}">
                                            ...
                                            {{ __('Confirme el cliente:') }}
                                        </label>
                                        <small class="help-block with-errors">*</small>
                                        <select id="FK_SolSerCliente" name="FK_SolSerCliente" class="form-control" required>
                                            @foreach ($Clientes as $ClienteOption)
                                            <option value="{{ $ClienteOption->ID_Cli }}" {{ (isset($clienteSeleccionado) && $clienteSeleccionado == $ClienteOption->ID_Cli) ? 'selected' : '' }}>{{ $ClienteOption->CliName }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @endif
								...
								<div id="transportadorContainer" class="row" style="background-color: #d9edf7">
									...
									<div id="Conductor" class="form-group col-md-6" hidden="true">
										...
										<input maxlength="255" type="text" class="form-control" id="SolSerConductor" name="SolSerConductor[]" value="{{ old('SolSerConductor')[0] ?? '' }}">
									</div>
									<div id="Vehiculo" class="form-group col-md-6" hidden="true">
										<label for="SolSerVehiculo">{{ __('adminlte::message.solservehic') }}</label>
										<input type="text" class="form-control placa" id="SolSerVehiculo" name="SolSerVehiculo[]" value="{{ old('SolSerVehiculo')[0] ?? '' }}">
									</div>
									...
									<div class="col-md-12 collapse Requerimientos" style="border: 2px dashed #00c0ef">
										...
										<div class="col-md-4" style="text-align: center;">
											<label data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{ __('adminlte::message.solservehicexclusi') }}</b>" data-content="<p style='width: 50%'> {{ __('adminlte::message.solservehicexclusidescrit') }} </p>">
												...
												<div style="width: 100%; height: 34px;">
													<input type="checkbox" {{(isset($Requerimientos[0]))&&($Requerimientos[0]['RequeCliVehicExclusive'] === 1) ? "" : "disabled"}}  {{(isset($Requerimientos[0]))&&($Requerimientos[0]['auto_RequeCliVehicExclusive'] === 1) ? "checked" : ""}} class="testswitch" id="SolSerVehicExclusive" name="SolSerVehicExclusive" {{ old('SolSerVehicExclusive') == 'on' ? 'checked' : '' }} hidden="">
												</div>
											</label>
										</div>
										<div class="col-md-4" style="text-align: center;">
...
$(document).ready(function(){
	$('#textDescription').on('keyup change', updatecaracteres);
	updatecaracteres();
})
</script>
