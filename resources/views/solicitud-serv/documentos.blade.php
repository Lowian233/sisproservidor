										...
										@case(0)
											@if (date('Y', strtotime($certificado->created_at)) < 2024)
												@if ($certificado->CertSrc!=="CertificadoDefault.pdf")
													@php
														...
														$certificadoImgPath = public_path('img/Certificados/' . $certificado->CertSrc);
													@endphp
													<td class="text-center"><a method='get' href='{{ file_exists($certificadoPath) ? asset('storage/certificadoRegular/'.$certificado->CertSrc) . '?v=' . filemtime($certificadoPath) : asset('img/Certificados/'.$certificado->CertSrc).'?v='.(file_exists($certificadoImgPath) ? filemtime($certificadoImgPath) : time()) }}' target='_blank' class='btn btn-success'><i class='fas fa-file-contract fa-lg'></a></td>
												@else
											...
											@else
												@if ($certificado->CertSrc!=="CertificadoDefault.pdf")
													@php
														$certificadoPath = storage_path('app/public/certificadoRegular/' . $certificado->CertSrc);
													@endphp
													<td class="text-center"><a method='get' href="{{ file_exists($certificadoPath) ? asset('storage/certificadoRegular/'.$certificado->CertSrc).'?v='.filemtime($certificadoPath) : asset('img/Certificados/'.$certificado->CertSrc).'?v='.(file_exists(public_path('img/Certificados/'.$certificado->CertSrc)) ? filemtime(public_path('img/Certificados/'.$certificado->CertSrc)) : time()) }}" target='_blank' class='btn btn-success'><i class='fas fa-file-contract fa-lg'></a></td>
												@else
													<td class="text-center"><a disabled method='get' href='/img/CertificadoDefault.pdf' target='_blank' class='btn btn-default'><i class='far fa-file-alt fa-lg'></a></td>
												@endif
											@endif
											...
											@if (date('Y', strtotime($certificado->created_at)) < 2024)
												@if ($certificado->CertSrcManif !== "CertificadoDefault.pdf")
													@php
														$_docManifName = ($certificado->CertSrc !== 'CertificadoDefault.pdf') ? $certificado->CertSrc : $certificado->CertSrcManif;
														$_docManifPath = storage_path('app/public/manifiestosRegular/'.$_docManifName);
														$_docManifImg = public_path('img/Manifiestos/'.$_docManifName);
													@endphp
													<td class="text-center"><a method='get' href='{{ file_exists($_docManifPath) ? asset('storage/manifiestosRegular/'.$_docManifName).'?v='.filemtime($_docManifPath) : asset('img/Manifiestos/'.$_docManifName).'?v='.(file_exists($_docManifImg) ? filemtime($_docManifImg) : time()) }}' target='_blank' class='btn btn-primary'><i class='far fa-file-alt fa-lg'></a></td>
												@else
													<td class="text-center"><a disabled method='get' href='/img/CertificadoDefault.pdf' target='_blank' class='btn btn-default'><i class='far fa-file-alt fa-lg'></a></td>
												@endif
											@else
												@php
													$_docManifName24 = ($certificado->CertSrc !== 'CertificadoDefault.pdf') ? $certificado->CertSrc : $certificado->CertSrcManif;
													$_docManifPath24 = storage_path('app/public/manifiestosRegular/'.$_docManifName24);
													$_docManifImg24 = public_path('img/Manifiestos/'.$_docManifName24);
												@endphp
												@if ($_docManifName24 !== "CertificadoDefault.pdf")
														<td class="text-center">
															<a method='get' href="{{ file_exists($_docManifPath24) ? asset('storage/manifiestosRegular/'.$_docManifName24).'?v='.filemtime($_docManifPath24) : asset('img/Manifiestos/'.$_docManifName24).'?v='.(file_exists($_docManifImg24) ? filemtime($_docManifImg24) : time()) }}" target='_blank' class='btn btn-primary'><i class='far fa-file-alt fa-lg'></a></td>
												@else
													<td class="text-center"><a disabled method='get' href='/img/CertificadoDefault.pdf' target='_blank' class='btn btn-default'><i class='far fa-file-alt fa-lg'></a></td>
												@endif
											@endif
