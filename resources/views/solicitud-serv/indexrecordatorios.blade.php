                        ...
                        <table id="SolicitudservicioTable" class="table table-compact table-bordered table-striped d-none">
                            ...
                            <tbody>
                                ...
                                <tr style="{{$Servicio->SolSerDelete == 1 ? 'color: red' : ''}}">
                                    <td id="{{'lastRecordatorio'.$Servicio->SolSerSlug}}">{{$Servicio->ultimoRecordatorio != null ? \Carbon\Carbon::parse($Servicio->ultimoRecordatorio->ObsDate)->diffForhumans() : ($Servicio->fechaRecepcionado != null ? \Carbon\Carbon::parse($Servicio->fechaRecepcionado->ObsDate)->diffForhumans() : "")  }}</td>
                                    ...
                                    <td>
                                        <button id="{{'buttonCertStatus'.$Servicio->SolSerSlug}}"
                                            ...
                                            class="{{'classSendRecordatorio'.$Servicio->SolSerSlug}} btn btn-{{$Servicio->SolSerStatus == 'Recepcionado' ? 'success' : 'default'}}">
                                            <i class="fas fa-envelope"></i>
                                        Recordatorio {{$Servicio->ultimoRecordatorio != null ? $Servicio->ultimoRecordatorio->ObsRepeat + 1 : ($Servicio->fechaRecepcionado != null ? $Servicio->fechaRecepcionado->ObsRepeat : "")  }}</button>
                                    </td>
                                    @endif
                                </tr>
                                @endforeach
