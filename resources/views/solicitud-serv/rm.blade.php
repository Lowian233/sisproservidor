...
<div class="container-fluid spark-screen">
    ...
    @foreach($GenerResiduos as $generadores)
		...
		<a href='#' id="btn-recibido" onclick="ModalStatus('{{$SolicitudServicio->SolSerSlug}}', 'Recibida')" class="btn btn-secondary pull-right disabled" style="pointer-events: none; opacity: 0.6;">
