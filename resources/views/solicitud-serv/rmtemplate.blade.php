...
footer {
    ...
    <body>
        <div class=WordSection1>
            <div align=center>
                    ...
                    <tr style='height:26.85pt'>
                        ...
                        @if($SolicitudServicio->SolSerTypeCollect === Null )
                            <td style='border-top:none; border-left:none ;border-bottom:none;border-right:none; padding:0cm 5.4pt 0cm 5.4pt;height:26.85pt'>
                                <p class=MsoNormal style='margin-bottom:0cm;line-height:normal'><span style='font-size:10.0pt;font-family:"Arial",sans-serif'>{{ $Cliente->SedeAddress ?? 'N/A' }}</span></p>
                            </td>
                        @else
                            <td style='border-top:none; border-left:none ;border-bottom:none;border-right:none; padding:0cm 5.4pt 0cm 5.4pt;height:26.85pt'>
                                <p class=MsoNormal style='margin-bottom:0cm;line-height:normal'><span style='font-size:10.0pt;font-family:"Arial",sans-serif'>{{ $GenerResiduo->GSedeAddress ?? 'N/A' }}</span></p>
                            </td>
                        @endif
                        <td style='border-top:none; border-left:none ;border-bottom:none;border-right:none; padding:0cm 5.4pt 0cm 5.4pt;height:26.85pt'>
                        ...
                        <td style='border-top:none; border-left:none;border-bottom:none;border-right:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;height:26.85pt'>
                            <p class=MsoNormal style='margin-bottom:0cm;line-height:normal'><span style='font-size:10.0pt;font-family:"Arial",sans-serif'>{{ $GenerResiduo->MunName ?? 'N/A' }}</span></p>
                        </td>
                    </tr>
                    <tr style='height:26.85pt'>
                        <td style='border-top:none; border-left:solid windowtext 1.0pt ;border-bottom:none;border-right:none; padding:0cm 5.4pt 0cm 5.4pt;height:26.85pt'>
                ...
                <table  width="100%" class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 style='border-collapse:collapse;border:none'>
                    <tr style='height:19.5pt'>
                        <td colspan="6" style='border:solid windowtext 1.0pt; border-top:none;background:#D6DCE4;padding:0cm 1.4pt 0cm 1.4pt;height:19.4pt'>
                ...
                <table width="100%" class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 style='border-collapse:collapse;border:none'>
                    ...
                    @endforeach
                     @foreach($Residuos as $Residuo)
                        <tr width="100%" style='height:22.8pt'>
                                <td style='border:solid windowtext 1.0pt; border-top:none;padding:0cm 1.4pt 0cm 1.4pt;height:22.8pt'>
                     ...
                     @endforeach
                    <tr width="100%" style='height:19.5pt'>
                        <td style='border:solid windowtext 1.0pt; border-top:none;padding:0cm 1.4pt 0cm 1.4pt;height:22.8pt' colspan="4">
                        ...
                        <td style='border:solid windowtext 1.0pt; border-top:none;padding:0cm 1.4pt 0cm 1.4pt;height:22.8pt' colspan="2">
                ...
                <br>
                <table  width="100%" class=MsoNormalTable cellspacing=0 cellpadding=0 style='border:solid windowtext 1.0pt'>
                    ...
                    <tr style='height:20.1pt'>
                        <td colspan=1 style='border-top:none;border-left:solid windowtext 1.0pt;border-bottom:none;border-right:solid windowtext 1.0pt; padding:0cm 1.4pt 0cm 1.4pt;height:20.1pt'>
                    ...
                    <tr style='height:21.1pt'>
                        <td colspan=1 style='border-top:none;border-left: solid windowtext 1.0pt;border-bottom:none;border-right:solid windowtext 1.0pt; padding:0cm 1.4pt 0cm 1.4pt;height:21.1pt'>
                            <p class=MsoNormal style='margin-bottom:0cm;text-align: justify; line-height:normal'><span style='font-size:8.0pt;font-family:"Arial",sans-serif'>c. Así mismo se hace constar que las puertas del furgón ha sido cerradas con candado y ha sido colocado y cerrado el <b>PRECINTO DE SEGURIDAD No. {{ $precintosString }}</b> en presencia de <b>{{ $firmas->NombreFuncionario ?: 'No registrado' }}</b> con cedula No.<b>{{ ($firmas->Cedula && $firmas->Cedula != '0') ? $firmas->Cedula : 'No registrado' }}</b></span></p>
                        </td>
                    </tr>
                    <tr style='height:19.4pt'>
                        <td colspan=1 style='border:solid windowtext 1.0pt; background:#D6DCE4;padding:0cm 1.4pt 0cm 1.4pt;height:19.4pt'>
                    ...
                    <tr style='height:21.1pt'>
                        <td colspan=1 style='border-top:none;border-left: solid windowtext 1.0pt;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt; padding:0cm 1.4pt 0cm 1.4pt;height:21.1pt'>
                ...
                <table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=100% style='width:100%;margin-left:-.25pt;border-collapse:collapse;border:none'>
                    ...
                    <tr width=100% style='height:19.5pt'>
                        ...
                        <td width=10% nowrap colspan=1 style='width:10pt;border:solid windowtext 1.0pt; border-left:solid windowtext 1.0pt;padding:0cm 3.5pt 0cm 3.5pt;height:19.5pt; vertical-align: middle;'>
                            <p class="MsoNormal" align="center" style="text-align:center; margin: 0;">
                                <b><span style="font-size:8.0pt; font-family: Arial, sans-serif;">Conductor:</span></b><br>
                                <span style="font-size:11.0pt; font-family: Arial, sans-serif; font-style: italic;">{{ $nombreConductor ?? 'No asignado' }}</span><br>
                                <span style="font-size:7.0pt; color:#666; letter-spacing: 2px;">_________________</span>
                            </p>
                        </td>
                        <td width=10% nowrap colspan=1 style='width:10pt;border:solid windowtext 1.0pt; border-left:solid windowtext 1.0pt;padding:0cm 3.5pt 0cm 3.5pt;height:19.5pt'>
                    ...
                    <tr width=100% style='height:19.5pt'>
                        <td width=10% nowrap colspan=1 style='width:10pt;border:solid windowtext 1.0pt; border-left:solid windowtext 1.0pt;padding:0cm 3.5pt 0cm 3.5pt;height:19.5pt'>
                            <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center; line-height:normal'><b><span style='font-size:8.0pt;font-family:"Arial",sans-serif'>Nombre: {{ $firmas->NombreFuncionario ?: 'No registrado' }} </span></b></p>
                        </td>
                        @if($SolicitudServicio->SolSerTypeCollect === Null )
                            <td width=10% nowrap colspan=1 style='width:10pt;border:solid windowtext 1.0pt; border-left:solid windowtext 1.0pt;padding:0cm 3.5pt 0cm 3.5pt;height:19.5pt'>
    ...
    <footer>
        ...
        <p class=MsoNormal align=center style='margin-bottom:0cm;text-align:center; line-height:normal'><span style='font-size:6.0pt;font-family:"Arial",sans-serif; color:#666666'>Nota:En caso de que, por cualquier motivo, el cliente no haya diligenciado el campo denominado “Entregado por” en el Recibo de material , el área de Logística procederá a completar dicho campo, exclusivamente con el fin de garantizar la continuidad de la operación y el cumplimiento del servicio.</span></p>
