                        ...
                        <div class="tab-content" style="min-height:40vh;">
                            ...
                            <div class="tab-pane fade " id="Proveedorpane">
                                ...
                                <div class="box box-info">
                                    <div class="box-body box-profile">
                                        <h3 class="profile-username text-center">{{ $Sede ? $Sede->SedeName : 'N/A' }}</h3>
                                        @if (Auth::user()->UsRol === __('adminlte::message.Administrador') && $Cliente)
                                        ...
                                        <ul class="list-group list-group-unbordered">
                                            <li class="list-group-item">
                                                ...
                                                <a href="#" class="pull-right textpopover" id="{{ __('adminlte::message.address') }}" title="{{ __('adminlte::message.address') }}" data-toggle="popover" data-trigger="focus" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{ $Sede ? $Sede->SedeAddress . ' - ' . ($Sede->MunName ?? '') . ', ' . ($Sede->DepartName ?? '') : 'N/A' }}</p>">{{ $Sede ? ($Sede->SedeAddress ?? '') . ' - ' . ($Sede->MunName ?? '') . ', ' . ($Sede->DepartName ?? '') : 'N/A' }}</a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>{{ __('adminlte::message.mobile') }}</b> <a class="pull-right">{{ $Sede ? ($Sede->SedeCelular ?? '') : '-' }}</a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>{{ __('adminlte::message.phone') }}</b> <a class="pull-right">{{ $Sede ? ($Sede->SedePhone1 ?? '') . ' - ' . ($Sede->SedeExt1 ?? '') : '-' }}</a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>{{ __('adminlte::message.phone') }} 2</b> <a class="pull-right">{{ $Sede ? ($Sede->SedePhone2 ?? '') . ' - ' . ($Sede->SedeExt2 ?? '') : '-' }}</a>
                                            </li>
                                            <li class="list-group-item">
                                                ...
                                                <a href="#" class="pull-right textpopover" id="{{ __('adminlte::message.emailaddress') }}" title="{{ __('adminlte::message.emailaddress') }}" data-toggle="popover" data-trigger="focus" data-html="true" data-placement="bottom" data-content="<p class='textolargo'>{{ $Sede ? ($Sede->SedeEmail ?? '') : '' }}</p>">{{ $Sede ? ($Sede->SedeEmail ?? '') : '-' }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- /.box-body -->
                                    ...
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        @foreach($tratamiento->pretratamientos as $pretratamiento)
                                            @if($pretratamiento->PreTratDelete == 0)
                                                <li class="list-group-item">
                                                    <b>{{$pretratamiento->PreTratName}}</b> <a href="#" class="pull-right textpopover" id="{{ __('adminlte::message.address') }}" title="Descripci??n del Pretratamiento" data-toggle="popover" data-trigger="focus" data-html="true" data-placement="bottom" data-content="{{$pretratamiento->PreTratDescription}}">{{$pretratamiento->PreTratDescription}}</a>
                                                </li>
                                                @php
                                ...
                                <div class="form-horizontal">
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        @foreach($tratamiento->clasificaciones as $clasificacion)
                                                <li class="list-group-item">
                                                    <b>{{$clasificacion->ClasfCode}}</b> <a href="#" class="pull-right textpopover" id="{{ __('adminlte::message.address') }}" title="Descripci??n del Pretratamiento" data-toggle="popover" data-trigger="focus" data-html="true" data-placement="bottom" data-content="{{$clasificacion->ClasfDescription}}">{{$clasificacion->ClasfDescription}}</a>
                                                </li>
                                                @php
